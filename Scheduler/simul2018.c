...
static int parse_opt(int key, char *arg, struct argp_state *state) {
    ...
    case 'p':
        ...
        break;
    case 't':
        arguments->ntry = strtol(arg, NULL, 10);
        break;
    case 's':
...
int main(int argc, char *argv[]) {
    ...
    struct argp_option options[] = {
        ...
        {"ntry", 't', "INT", 0, "aantal pogingen om nieuwe memory in te laden.", 0},
        {0, 0, 0, 0, "Optioneel:", -1},
    ...
    while (proc_num < 100) {
        ...
        case NEW_PROCESS_EVENT:
            ...
            schedule(cur_event, arguments.ntry, arguments.proc);
